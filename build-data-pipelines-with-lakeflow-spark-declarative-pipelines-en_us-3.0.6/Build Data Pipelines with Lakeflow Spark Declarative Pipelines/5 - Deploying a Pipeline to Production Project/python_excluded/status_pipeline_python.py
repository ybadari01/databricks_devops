...
@dp.table(name = "1_bronze_db.status_bronze_demo5",
...
@dp.table(name = "2_silver_db.status_silver_demo5",
...
def status_silver_demo5():
    return (
        dp.read_stream("1_bronze_db.status_bronze_demo5")
           .select(
                "order_id",
                "order_status",
...
def full_order_info_gold_demo5():
    return (
        ...
        .join(dp.read("2_silver_db.orders_silver_demo5").alias("orders"), on = "order_id", how = "inner")
        .select(
            "orders.order_id",
...
def cancelled_orders_gold_demo5():
    full_orders = dp.read("3_gold_db.full_order_info_gold_demo5")
    return (
        full_orders
