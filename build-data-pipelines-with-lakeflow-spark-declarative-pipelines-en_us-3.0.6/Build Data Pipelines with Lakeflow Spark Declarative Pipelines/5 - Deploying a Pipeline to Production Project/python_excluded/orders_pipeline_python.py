...
@dp.table(name = "1_bronze_db.orders_bronze_demo5",
...
@dp.table(name = "2_silver_db.orders_silver_demo5",
...
def orders_silver_demo5():
    return (
        dp.read_stream("1_bronze_db.orders_bronze_demo5")
            .select(
                "order_id",
...
@dp.materialized_view(name = "3_gold_db.gold_orders_by_date_demo5",
...
def gold_orders_by_date_demo5():
    return (
        dp.read("2_silver_db.orders_silver_demo5")
